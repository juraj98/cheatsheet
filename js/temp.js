$(document).ready(function() {
	...
	//	classInit();
	//
	//	console.info("%cFunction call:\t" + "%cresizeInit()", "color: #7986CB; font-weight:700", "color: #7986CB");
	//	resizeInit();
	//
	//	console.info("%cFunction call:\t" + "%cclassResize()", "color: #7986CB; font-weight:700", "color: #7986CB");
	//	classResize();
	//
