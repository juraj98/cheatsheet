...
const ERR_MSG_WORNG_ID_TOKEN = "Wrong google ID token.";
const ERR_MSG_QUERY_FAILED = "Query failed.";
...
const ERR_MSG_WRONG_INVITE_TOKEN = "Wrong invite token.";
const ERR_MSG_NO_FILES = "No files recieved.";
